...
# Load dataset
data <- read.csv("~/MGS 662 Project/mythDataSet.csv")
...
train_labels <- as.numeric(as.character(trainData$MythAnnotation))
test_labels <- as.numeric(as.character(testData$MythAnnotation))
